...
-- Default admin (Set your password hash line 41)
INSERT INTO admins (email, name, password_hash, role)
VALUES (
  'admin@creationhub.local',
  'Administrator',
  'PASTE_YOUR_BCRYPT_HASH_HERE', -- changeme123
  'admin'
);
...
('openclaw_agent_1',  'OpenClaw: agent_1',      'Personal AI Agent',               'ai',           'creationhub_openclaw_agent_1',   '3011', '🦾', '#f59e0b', false, '{"ai","openclaw"}'),
('openclaw_agent_2',  'OpenClaw: agent_2',      'Personal AI Agent',               'ai',           'creationhub_openclaw_agent_2',   '3012', '🦾', '#f59e0b', false, '{"ai","openclaw"}'),
('openclaw_agent_3',   'OpenClaw: agent_3',       'Personal AI Agent',               'ai',           'creationhub_openclaw_agent_3',    '3013', '🦾', '#f59e0b', false, '{"ai","openclaw"}'),
('openclaw_agent_4',   'OpenClaw: agent_4',       'Personal AI Agent',               'ai',           'creationhub_openclaw_agent_4',    '3014', '🦾', '#f59e0b', false, '{"ai","openclaw"}'),
('jarvis',        'Jarvis',              'System Agent 24/7',               'ai',           'creationhub_jarvis',         '3015', '🤖', '#6366f1', true,  '{"ai","openclaw","system"}'),
...
CREATE TABLE openclaw_agents (
  id              UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  name            TEXT NOT NULL,                    -- 'agent_1', 'agent_2', 'Jarvis'
  slug            TEXT UNIQUE NOT NULL,             -- 'agent_1', 'agent_2', 'jarvis'
  ...
  telegram_chat_id    TEXT,
  telegram_username   TEXT,
  is_system_agent BOOLEAN NOT NULL DEFAULT false,   -- true only for Jarvis
  is_active       BOOLEAN NOT NULL DEFAULT true,
...
('Jarvis', 'jarvis', 3015, 'creationhub_jarvis', 'System Agent 24/7 — Server Administrator', true),
('agent_1',   'agent_1',    3011, 'creationhub_openclaw_agent_1', 'Personal AI Agent', false),
('agent_2',   'agent_2',    3012, 'creationhub_openclaw_agent_2', 'Personal AI Agent', false),
('agent_3',    'agent_3',     3013, 'creationhub_openclaw_agent_3',  'Personal AI Agent', false),
('agent_4',    'agent_4',     3014, 'creationhub_openclaw_agent_4',  'Personal AI Agent', false);
...
('backup_path',           '/home/user/backups',    'Default backup destination'),
...
('jarvis_telegram_enabled', 'false',             'Enable Jarvis Telegram bot'),
...
-- Default Admin (Set your password hash line 534)
INSERT INTO admins (email, password_hash, name, role, totp_secret)
VALUES ('admin@creationhub.local', 'PASTE_YOUR_BCRYPT_HASH_HERE', 'Super Admin', 'admin', NULL)
